...
ggplot(data_percentage, aes(fill = participation, y = percent, x = challenge)) +
  ...
  scale_x_discrete(labels = c("Geeignete Angebote 
                              zur Beteiligung finden", 
                              "Mitarbeitende zur 
                              Teilnahme gewinnen", 
                              "Koordination der Mitarbeitenden", 
                              "Begrenzte Zeit von Mitarbeitenden", 
