...
merged_df2 <- merged_df %>%
  ...
  mutate(per = eachc / sum) #calculate the mean of each challenge in each industry
...
ggsave("8.1question.png", device = "png", width = 16, height = 9)

# Bar Chart for Mean Percentage
...
ggsave("8.2question.png", device = "png", width = 16, height = 9)
