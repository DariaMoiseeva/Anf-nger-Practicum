...
ggplot(data.Q2.A,aes(x = factor(class, levels = c("Kleine Unternehmen","Mittlere Unternehmen","Großunternehmen"),labels = c("Small","Middle","Big")),y = percent, fill = factor(frequency))) +
